module.exports = {
  siteTitle: 'GCN',
  siteTitleAlt: 'GCN Gatsby Starter Alt', // This allows an alternative site title for SEO schema.
  shortTitle: 'shortGCN', // Used for App manifest e.g. Mobile Home Screen
